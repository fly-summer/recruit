...
<body>
				...
				<div class="col-md-12 col-xs-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<form action="doGraduateReg.do" class="form-horizontal" id="form" role="form" method="post" onSubmit="return checkForm()">
								<div class="form-group">
									<label for="userName" class="control-label col-md-2">账户：</label>
									<div class="col-md-4 has-feedback">
										<input type="text" class="form-control" id="userName" name="sname" placeholder="请输入用户名" onChange="checkUserName()"
								...
								<div class="form-group">
									...
									<div class="col-md-4 has-feedback">
										<input type="password" class="form-control" id="password" name="password" placeholder="请输入密码" onChange="checkPasswd()"
										 onBlur="checkPasswd()">
										<span class="glyphicon form-control-feedback" aria-hidden="true"></span>
									</div>
									<div class="col-md-5">
								...
								<div class="form-group">
									...
									<div class="col-md-4 has-feedback">
										<input type="text" class="form-control" id="name" name="name" placeholder="请输入姓名" onChange="checkName()"
										 onBlur="checkName()">
										<span class="glyphicon form-control-feedback" aria-hidden="true"></span>
									</div>
									<div class="col-md-5">
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<div class="input-group date">
											<input type="text" class="form-control" id="birth" name="birth" placeholder="请输入出生日期" onChange="checkBirth()"
											 onBlur="checkBirth()">
								...
								<div class="form-group">
									...
									<div class="col-md-4 has-feedback">
										<input type="text" class="form-control" id="tel" name="tel" placeholder="请输入手机或电话号码" onChange="checkTel()"
										 onBlur="checkTel()">
										<span class="glyphicon form-control-feedback" aria-hidden="true"></span>
									</div>
									<div class="col-md-5">
								...
								<div class="form-group">
									...
									<div class="col-md-4 has-feedback">
										<input type="text" class="form-control" id="email" name="email" onChange="checkEmail()" placeholder="请输入邮箱地址"
										 onBlur="checkEmail()">
										<span class="glyphicon form-control-feedback" aria-hidden="true"></span>
									</div>
									<div class="col-md-5">
								...
								<div class="form-group">
									...
									<div class="col-md-4 has-feedback">
										<input type="text" class="form-control" id="degree" name="degree" placeholder="请输入填写最高学历"> <span class="glyphicon form-control-feedback"
								...
								<div class="form-group">
									...
									<div class="col-md-4 has-feedback">
										<input type="text" class="form-control" id="position" name="position" placeholder="请输入求职意向"> <span class="glyphicon form-control-feedback"
										 aria-hidden="true"></span>
									</div>
									<div class="col-md-5">
								...
								<div class="form-group">
									...
									<div class="col-md-4 has-feedback">
										<input type="text" class="form-control" id="status" name="status" placeholder="请输入填写具体职位"> <span class="glyphicon form-control-feedback"
										 aria-hidden="true"></span>
									</div>
									<div class="col-md-5">
										<span class="help-block small"></span>
	...
	<script type="text/javascript">
		...
		function checkUserName() {
			...
			$userName.next().removeClass('glyphicon-ok glyphicon-remove');
			var userName = $userName.val();
			if (userName == "" || userName.length < 4 || (userName != "" && !/^[a-zA-Z0-9_-]{4,16}$/.test(userName))) {
		...
		function checkForm() {
			return checkUserName() && checkName() && checkPasswd() && checkpwd2() && checkTel() && checkEmail();
		}
	</script>
</body>
