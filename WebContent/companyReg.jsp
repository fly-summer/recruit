...
<body>
                ...
                <div class="col-md-12 col-xs-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form action="doCompanyRegister.do" class="form-horizontal" id="form" role="form" method="POST"
                                onsubmit="return checkForm()">

                                <div class="form-group">
                                    <label for="userName" class="control-label col-md-2">账户：</label>
                                    <div class="col-md-4 has-feedback">
                                        <input type="text" class="form-control" id="userName" name="cname" placeholder="请输入账户名"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4 has-feedback">
                                        <input type="text" class="form-control" id="name" name="name" placeholder="请输入公司名称"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4 has-feedback">
                                        <input type="text" class="form-control" id="tel" name="tel" placeholder="请输入手机或电话号码"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <textarea class="form-control" id="detailInfo" name="detail" rows="6"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
    ...
    <script type="text/javascript">
        ...
        function checkForm() {
            return checkUserName() && checkPasswd() && checkpwd2() && checkName() && checkTel();
        }
    </script>
</body>
